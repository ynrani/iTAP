...
public class RestClient {
	 ...
	 *
	 * @param httpclient
	 *            Underlying HTTP client to use
	 * @param uri
	 *            Base URI of the remote REST service
	 */
	 ...
	 *            Underlying HTTP client to use
	 * @param creds
	 *            Credentials to send with each request
	 * @param uri
	 *            Base URI of the remote REST service
	 */
	...
	private JSON request(HttpRequestBase req) throws RestException, IOException {
		...
		if (ent != null) {
			...
			InputStreamReader isr = encoding != null ? new InputStreamReader(ent.getContent(),
					encoding) : new InputStreamReader(ent.getContent());
	...
	private JSON request(HttpEntityEnclosingRequestBase req, String payload) throws RestException,
			IOException {
	...
	private JSON request(HttpEntityEnclosingRequestBase req, File file) throws RestException,
			IOException {
		if (file != null) {
	...
	private JSON request(HttpEntityEnclosingRequestBase req, JSON payload) throws RestException,
			IOException {
	 ...
	 *             when an error occurred appending the path to the URI
	 */
	public JSON get(String path, Map<String, String> params) throws RestException, IOException,
			URISyntaxException {
	 ...
	 * Content-Type header. You should not use this function when proper JSON is
	 * expected.
	 *
	 ...
	 *             when an error occurred appending the path to the URI
	 */
	public JSON post(String path, JSON payload) throws RestException, IOException,
			URISyntaxException {
	 ...
	 * @throws RestException
	 */
	public JSON post(String path, Issue.NewAttachment... attachments) throws RestException,
	 ...
	 *             when an error occurred appending the path to the URI
	 */
	public JSON put(String path, JSON payload) throws RestException, IOException,
			URISyntaxException {

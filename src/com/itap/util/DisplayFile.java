...
public class DisplayFile {
	...
	public static void main(String[] args) {
		 ...
		 * Default values:
		 */
		String url = "http://in-pnq-coe02.corp.capgemini.com:7171/svn/CoE/TCOE/ITAP/ITAP-CIA/ITAP-Code/ITAP/ITAP";
		String name = "sechowda";
		String password = "Cap@1234";
		String filePath = "WebContent/jsp/config.jsp";
		/*
		...
		try {
			 ...
			 */
			System.err.println("error while creating an SVNRepository for the location '" + url
					+ "': " + svne.getMessage());
			System.exit(1);
		}
		...
		try {
			...
			System.err.println("error while fetching the file contents and properties: "
					+ svne.getMessage());
			System.exit(1);
		}
